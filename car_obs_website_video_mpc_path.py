...
path_filename = '/media/arclabdl1/HD1/Linjun/mpc-mpnet-py/results/traj/car_obs/shm/%d/env_%d_id_%d.npy' % (obs_idx, obs_idx, p_idx)
...
ani.save('car_env%d_path%d_mpc_path.mp4' % (obs_idx, p_idx), fps=50)
