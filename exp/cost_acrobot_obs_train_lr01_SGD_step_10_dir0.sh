...
--AE_input_size 32 --mlp_input_size 136 --output_size 1 --learning_rate 0.0025 --device 2 --num_epochs 5000 \
--batch_size 256 --path_folder ./data/acrobot_obs/ --path_file path.pkl --start_epoch 0 --env_type acrobot_obs \
--world_size 3.141592653589793 3.141592653589793 6.0 6.0 --direction 0 --opt SGD --num_steps 10
cd exp
#10x800
