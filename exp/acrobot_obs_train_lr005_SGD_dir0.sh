cd ..
python neural_train_waypoint.py --model_path /media/arclabdl1/HD1/YLmiao/results/KMPnet_res/acrobot_obs_lr005_SGD/ --no_env 10 --no_motion_paths 400 --total_input_size 8 \
