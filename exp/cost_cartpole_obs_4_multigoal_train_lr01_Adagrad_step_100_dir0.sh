...
--AE_input_size 32 --mlp_input_size 40 --output_size 1 --learning_rate 0.01 --device 1 --num_epochs 10000 \
--batch_size 256 --path_folder ./data/cartpole_obs/ --path_file path.pkl --start_epoch 0 --env_type cartpole_obs_4_multigoal \
