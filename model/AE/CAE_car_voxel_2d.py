...
class Encoder(nn.Module):
    ...
    def __init__(self, input_size=32, output_size=128):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=16, kernel_size=[6,6], stride=[2,2]),   # 14x14
            nn.PReLU(),
            nn.MaxPool2d(2, stride=2),   # result: 7x7
            nn.Conv2d(in_channels=16, out_channels=8, kernel_size=[3,3], stride=[2,2]),   # 3x3
            nn.PReLU(),
