...
--AE_input_size 32 --mlp_input_size 136 --output_size 4 --learning_rate 0.01 --device 0 \
--path_folder ../data/acrobot_obs/ --path_file path.pkl --start_epoch 5000 --env_type acrobot_obs \
